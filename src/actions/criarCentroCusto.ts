...
export async function criarCentroCusto(_estado: ResultadoAcao, formData: FormData): Promise<ResultadoAcao> {
  ...
  const resultado = await inserirRegistro("centros_custo", {
